# Zgłoszenie aktualizacji danych rejestracyjnych Pola z jego wyposażeniem
...
Zgłoszenie aktualizacji danych strukturalnych Pola wraz z jego wyposażeniem dotyczy przekazywania danych i informacji do
OSP o istniejących oraz nowych inwestycjach w 5'o letnim horyzoncie planowania, ich planowanym rozwoju, a także na
potrzeby rejestracji i aktualizacji istniejących, oraz planowanych do przyłączenia w 5'o letnim horyzoncie planowania
MWE typu D, C, B, A, a także MEE o łącznej mocy zainstalowanej > 50 kW.
...
mRID'y aktualizowanych obiektów.

## Status obsługi zgłoszenia:

| Status zgłoszenia                     | Opis                                                                                                                          |
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|
| _Zgłoszenie przesłane do akceptacji_  | _Zgłoszenie aktualizacji danych strukturalnych Pola wraz z wyposażeniem przyjęte w systemie OSP i oczekujące na weryfikację._ |
| **Zgłoszenie zatwierdzone**           | **Aktualizacja danych strukturalnych Pola wraz z wyposażeniem w systemie OSP.**                                               |
| **Zgłoszenie zatwierdzone ze zmianą** | **Aktualizacja danych strukturalnych Pola wraz z wyposażeniem oraz wraz z wprowadzonymi zmianami przez pracownika OSP.**      |
| _Zgłoszenie w korekcie_               | _Zgłoszenie aktualizacji danych strukturalnych Pola wraz z wyposażeniem zwrócone do OSDp do poprawy i oczekujące na korektę._ |
| **Zgłoszenie odrzucone**              | **Brak aktualizacji danych strukturalnych Pola wraz z wyposażeniem w systemie OSP.**                                          |
