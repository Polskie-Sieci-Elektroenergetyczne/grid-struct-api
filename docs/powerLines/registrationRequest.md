# Zgłoszenie danych rejestracyjnych Linii elektroenergetycznej
...
Zgłoszenie danych rejestracyjnych Linii elektroenergetycznej dotyczy przekazywania danych i informacji do OSP o
...
* **dane elektryczne** (rezystancja R, rezystancja R0, reaktancja X, reaktancja zerowa X0, połowa susceptancji B/2,
  ...
  obciążalność linii w okresie letnim, dopuszczalna obciążalność linii w okresie zimowym, dane na 1 km)* **parametry
  odcinków:** (
  numer odcinka,
  rodzaj przewodu
  roboczego,
...
|---------------------------------------|------------------------------------------------------------------------------------------------------------------|
| _Zgłoszenie przesłane do akceptacji_  | _Zgłoszenie rejestracji Linii elektroenergetycznej przyjęte w systemie OSP i oczekujące na weryfikację._         |
| **Zgłoszenie zatwierdzone**           | **Zarejestrowanie nowego obiektu Linia elektroenergetyczna w systemie OSP.**                                     |
| **Zgłoszenie zatwierdzone ze zmianą** | **Zarejestrowanie nowego obiektu Linia elektroenergetyczna wraz z wprowadzonymi zmianami przez pracownika OSP.** |
| _Zgłoszenie w korekcie_               | _Zgłoszenie rejestracji Linii elektroenergetycznej zwrócone do OSDp do poprawy i oczekujące na korektę._         |
| **Zgłoszenie odrzucone**              | **Brak rejestracji nowego obiektu Linia elektroenergetyczna w systemie OSP.**                                    |
